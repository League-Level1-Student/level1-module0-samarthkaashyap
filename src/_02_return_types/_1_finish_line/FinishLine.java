...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if (finished == true) {
			JOptionPane.showMessageDialog(null, "The robot finished and it went " + distance + " kilometers");
		}
		else {
			JOptionPane.showMessageDialog(null, "The robot did not finish and it went " + distance + " kilometers");
		}
